...
<script>
    ...
    function doubleClick(event,treeId,treeNode) {
        var id=treeNode.id;
        $("#main").attr("src","${path}/module/baseInfo/stuff-view.jsp?id="+id);
        /**
         * 获取点击对象的ID
         * 通过target来获取打开页面*/
    }
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            $("#main").attr("src","${path}/module/baseInfo/stuff-view.jsp?id="+null);
        }
    })
    //屏蔽双击中的单击事件
