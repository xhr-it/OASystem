        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="post" onsubmit="return false;">
                <div class="form-group">
                    <label class="col-md-3 control-label" for="actorname">角色姓名</label>
                    <div class="col-md-7">
                        <input class="form-control" type="text" id="actorname" name="name" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="actordesc">角色描述</label>
                    <div class="col-md-7">
                        <input class="form-control" type="text" id="actordesc" name="name" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="actorstate">角色状态</label>
                    <div class="col-md-7">
                        <select class="form-control" id="actorstate" code="BM_STATE"  size="1">
                            <option>请选择</option>
                        </select>
                    </div>
                </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="saveBtn" onclick="addActor()">点击保存</button>
</div>
...
<script>
    ...
    $("#actorname").blur(function () {
        $.ajax({
            url:"${path}/actor/actorUnique",
            data:{username:$("#actorname").val(),id:null},
            dataType:"json",
            type:"post",
            success:function (data) {
                console.log(data)
                if (data.state==true){
                    ...
                    setTimeout(function() {
                        ...
                        lightyear.notify('用户名重复~','danger', 100,'mdi mdi-emoticon-happy','bottom');
                    }, 1e2)
    ...
    function addActor(){
        var obj={actorname:$("#actorname").val(),actordesc:$("#actordesc").val(),actorstate:$("#actorstate").val()};
        console.log(obj);
        $.ajax({
            url:"${path}/actor/addActor",
